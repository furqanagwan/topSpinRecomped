...
macro(rexglue_setup_target target_name)
    if(REXGLUE_ENTRYPOINT_GENERATED_SOURCES)
        ...
        rexglue_apply_recomp_settings(${target_name}_recomp
            "${REXGLUE_ENTRYPOINT_INCLUDE_DIR}/top_spin_3_pch.h")
        add_dependencies(${target_name}_recomp top_spin_3_codegen)
        target_link_libraries(${target_name} PRIVATE
            ${target_name}_recomp)
    endif()
    # Also on the host, so a tree that has never run codegen still generates it.
    add_dependencies(${target_name} top_spin_3_codegen)
...
add_custom_command(
    ...
    COMMENT "Generating recompiled code for top_spin_3"
    VERBATIM
)
